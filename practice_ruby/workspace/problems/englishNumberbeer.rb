...
while count > 0
  puts (englishNumber count).to_s.capitalize + ' bottles of beer on the wall, '  + (englishNumber count).to_s + ' bottles of beer, you take one down, pass it around, ' + (englishNumber count - 1).to_s + ' bottles of beer on the wall!'
  count -= 1       
end  